...
namespace ItemPickHint.ModdingUtils
{
    public static class ReflectionUtils
    {
        public static object SetPrivateField(this object target, string fieldName, object value)
        {
            ...
            if (fieldInfo == null)
            {
                Debug.LogWarning($"VEI: Cannot find field {fieldName} in object {target}, fail to set value.");
                return target;
            }
        ...
        public static object? GetPrivateField(object target, string fieldName)
        {
            ...
            Debug.LogWarning($"VEI: Cannot find field {fieldName} in object {target}, fail to get value.");
            return null;
        }
    }
}